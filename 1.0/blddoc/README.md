...
2. Open terminal window, `cd` to `AISVS-main/1.0/blddoc` directory and run `shasum -a 256 owasp_pdf` to calculate the sha256 hash code of `owasp_pdf` executable. It should match 35ec7275a22cd83f35d56cdd4e0dfe923a370ee5377a246c3a8d8cf7ed1b12a9
...
35ec7275a22cd83f35d56cdd4e0dfe923a370ee5377a246c3a8d8cf7ed1b12a9  owasp_pdf
$ ./owasp_pdf -v
OWASP_PDF Version: OWASP PDF v5.0.0 20250925-202425
