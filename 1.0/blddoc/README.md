...
2. Open terminal window, `cd` to `AISVS-main/1.0/blddoc` directory and run `shasum -a 256 owasp_pdf` to calculate the sha256 hash code of `owasp_pdf` executable. It should match 7cf284a7998958053ab786eb3abdd054011401e1b9a3faf7ee35315bf84b3a84
...
7cf284a7998958053ab786eb3abdd054011401e1b9a3faf7ee35315bf84b3a84  owasp_pdf
$ ./owasp_pdf -v
OWASP_PDF Version: OWASP PDF v5.0.0 20250822-214519
