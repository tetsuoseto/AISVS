...
2. Open terminal window, `cd` to `AISVS-main/1.0/blddoc` directory and run `shasum -a 256 owasp_pdf` to calculate the sha256 hash code of `owasp_pdf` executable. It should match 6d248c8128ce227f580d494ad66bab53105d8a2dea710a7b68bf19a194382e95
...
6d248c8128ce227f580d494ad66bab53105d8a2dea710a7b68bf19a194382e95  owasp_pdf
$ ./owasp_pdf -v
OWASP_PDF Version: OWASP PDF v5.0.0 20250819-213848
