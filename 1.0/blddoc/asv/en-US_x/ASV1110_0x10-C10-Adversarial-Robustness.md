...
| 10.1.4 | Verify that counter-jailbreak training is properly documented and can be consistently reproduced.                                                                       |   2   |  D   |
...
| 10.3.2 | Verify that training utilizes ε-bounded differentially private optimization for sensitive datasets.              |   2   |  D   |
...
| 10.5.2 | Verify that the query-entropy and input-plurality statistics are used to feed an automated extraction detector.                |   2   | D/V  |
...
| 10.5.5 | Ensure that extraction-alert events include offending queries and are integrated with incident response playbooks.             |   3   |  V   |
...
| 10.6.2 | Verify that detector thresholds are adjusted on clean and poisoned validation sets to achieve less than 5% false positives. |   1   |  V   |
| 10.6.3 | Verify that inputs identified as poisoned trigger soft-blocking and human review workflows.                                 |   2   |  D   |
| 10.6.4 | Ensure that detectors undergo stress testing using adaptive, triggerless backdoor attacks.                                  |   2   |  V   |
...
|   #    | Description                                                                                                                        | Level | Role |
| :----: | ---------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 10.8.1 | Verify that the agent's reflection mechanisms include security-focused self-assessment of its decisions and actions.               |   1   | D/V  |
...
| 10.9.5 | Verify that recursive self-improvement is constrained by formal safety limits using mathematical proofs of convergence.              |   3   | D/V  |
