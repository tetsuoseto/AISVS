...
| :----: | -------------------------------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 10.1.1 | Verify that an alignment test suite (red team prompts, jailbreak probes, disallowed content) is version-controlled and executed for every model release. |   1   | D/V  |
...
| 10.4.2 | Verify that query rate limits restrict repeated adaptive queries from the same principal.                              |   1   | D/V  |
...
| 10.5.2 | Verify that query entropy and input plurality statistics support an automated extraction detector.                                   |   2   | D/V  |
...
|   #    | Description                                                                                                               | Level | Role |
| :----: | ------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 10.6.1 | Verify that inputs pass through an anomaly detector (e.g., STRIP, consistency scoring) before performing model inference. |   1   |  D   |
...
|   #    | Description                                                                                                                                   | Level | Role |
| :----: | --------------------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 10.7.1 | Ensure that security policies can be updated dynamically without restarting the agent, while preserving the integrity of the policy versions. |   1   | D/V  |
...
| 10.8.5 | Confirm that continuous learning from security reflections enhances threat detection without compromising legitimate functionality. |   3   | D/V  |
...
|   #    | Description                                                                                                                          | Level | Role |
| :----: | ------------------------------------------------------------------------------------------------------------------------------------ | :---: | :--: |
| 10.9.1 | Verify that self-modification capabilities are limited to designated safe areas with clearly defined formal verification boundaries. |   1   | D/V  |
...
| 10.9.5 | Verify that recursive self-improvement is limited by formal safety constraints with mathematical proofs of convergence.              |   3   | D/V  |
