...
| :----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---: | :--: |
| 12.1.1 | Ensure that all user prompts and model responses are recorded with suitable metadata, such as timestamp, user ID, session ID, and model version.                                           |   1   | D/V  |
...
| 12.1.5 | Verify that policy decisions and safety filtering actions are logged with sufficient detail to allow auditing and debugging of content moderation systems.                                 |   2   | D/V  |
...
|   #    | Description                                                                                                                                                                      | Level | Role |
| :----: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 12.2.1 | Verify that the system identifies and alerts on known jailbreak patterns, prompt injection attempts, and adversarial inputs using signature-based detection.                     |   1   | D/V  |
...
|   #    | Description                                                                                                                                                            | Level | Role |
| :----: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 12.3.1 | Ensure the system tracks essential performance metrics such as accuracy, confidence scores, latency, and error rates across different model versions and time periods. |   1   | D/V  |
...
| 12.3.3 | Verify that hallucination detection monitors recognize and flag instances when model outputs include factually incorrect, inconsistent, or fabricated information.     |   2   | D/V  |
...
| 12.4.3 | Verify that resource utilization monitoring includes GPU and CPU usage, memory consumption, and storage requirements, with alerts triggered when thresholds are exceeded. |   2   | D/V  |
...
|   #    | Description                                                                                                                         | Level | Role |
| :----: | ----------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 12.6.1 | Verify that DAG visualization data is sanitized to remove any sensitive information before storage or transmission.                 |   1   | D/V  |
...
| 12.6.3 | Ensure that DAG data integrity is safeguarded through cryptographic signatures and tamper-evident storage mechanisms.               |   2   | D/V  |
...
|   #    | Description                                                                                                                   | Level | Role |
| :----: | ----------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 12.7.1 | Ensure that proactive agent behaviors are security-validated before execution by integrating risk assessment.                 |   1   | D/V  |
...
| 12.7.4 | Ensure that security-critical proactive actions require explicit approval chains complete with audit trails.                  |   3   | D/V  |
