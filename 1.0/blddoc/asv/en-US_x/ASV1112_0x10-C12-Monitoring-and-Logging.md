...
| :----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---: | :--: |
| 12.1.1 | Verify that all user prompts and model responses are logged with the appropriate metadata (e.g., timestamp, user ID, session ID, model version).                                           |   1   | D/V  |
...
| 12.1.3 | Verify that log storage systems use encryption both at rest and in transit to protect sensitive information in the logs.                                                                   |   1   | D/V  |
...
| 12.1.5 | Ensure that policy decisions and safety filtering actions are logged with enough detail to allow auditing and debugging of content moderation systems.                                     |   2   | D/V  |
| 12.1.6 | Verify that log integrity is protected through cryptographic signatures or write-only storage, for example.                                                                                |   2   | D/V  |
...
|   #    | Description                                                                                                                                                                      | Level | Role |
| :----: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 12.2.1 | Verify that the system identifies and alerts on known jailbreak patterns, prompt injection attempts, and adversarial inputs through signature-based detection.                   |   1   | D/V  |
...
|   #    | Description                                                                                                                                                        | Level | Role |
| :----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---: | :--: |
| 12.3.1 | Ensure the system tracks basic performance metrics such as accuracy, confidence scores, latency, and error rates across different model versions and time periods. |   1   | D/V  |
| 12.3.2 | Verify that automated alerting is triggered when performance metrics exceed predefined degradation thresholds or deviate significantly from baselines.             |   2   | D/V  |
...
|   #    | Description                                                                                                                                                                | Level | Role |
| :----: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 12.5.1 | Ensure that incident response plans explicitly cover AI-related security incidents, including model compromise, data poisoning, and adversarial attacks.                   |   1   | D/V  |
...
| 12.5.3 | Verify that concept drift detection accurately identifies changes in the relationship between inputs and expected outputs.           |   2   | D/V  |
...
| 12.5.5 | Verify that the degradation root cause analysis links performance drops to data changes, infrastructure issues, or external factors. |   3   |  V   |
...
| 12.6.4 | Ensure that workflow visualization systems implement input validation to prevent injection attacks through manipulated node or edge data. |   2   | D/V  |
...
| 12.7.4 | Ensure that security-critical proactive measures require explicit approval chains accompanied by audit trails.                 |   3   | D/V  |
