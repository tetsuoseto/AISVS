...
| :---: | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---: | :--: |
| 6.1.1 | Ensure that every third-party model artifact contains a signed provenance record that identifies the source repository and commit hash.                      |   1   | D/V  |
...
| 6.1.5 | Ensure that high-risk models (with publicly uploaded weights and unverified creators) stay quarantined until they undergo human review and receive sign-off. |   3   | D/V  |
...
|   #   | Description                                                                                                | Level | Role |
| :---: | ---------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 6.2.1 | Verify that CI pipelines execute dependency scanners on AI frameworks and essential libraries.             |   1   | D/V  |
...
| 6.3.5 | Confirm that expired dependencies initiate automated pull requests to update or fork pinned versions. |   3   |  D   |
...
| 6.4.4 | Verify that repository allow-lists are reviewed quarterly, with documented business justification provided for each entry.   |   2   |  V   |
...
|   #   | Description                                                                                                            | Level | Role |
| :---: | ---------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 6.5.1 | Ensure that external datasets are subject to poisoning risk assessment (e.g., data fingerprinting, outlier detection). |   1   | D/V  |
...
| 6.5.5 | Verify that disallowed content (copyright, PII) is removed through automated scrubbing before training.                |   3   |  D   |
...
| 6.6.3 | Verify that threat-intelligence enrichment tags machine learning-specific indicators (e.g., model-poisoning IoCs) during alert triage. |   3   |  V   |
