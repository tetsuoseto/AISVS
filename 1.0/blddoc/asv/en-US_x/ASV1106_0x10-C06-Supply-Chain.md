...
| 6.4.4 | Verify that repository allowlists are reviewed quarterly with evidence of business justification for each entry.             |   2   |  V   |
...
|   #   | Description                                                                                                        | Level | Role |
| :---: | ------------------------------------------------------------------------------------------------------------------ | :---: | :--: |
| 6.5.1 | Ensure that external datasets undergo poisoning risk assessment (e.g., data fingerprinting, outlier detection).    |   1   | D/V  |
...
|   #   | Description                                                                                                                     | Level | Role |
| :---: | ------------------------------------------------------------------------------------------------------------------------------- | :---: | :--: |
| 6.6.1 | Ensure that CI/CD audit logs are streamed to SIEM for detecting anomalous package downloads or tampered build steps.            |   1   |  V   |
...
| 6.7.4 | Ensure that downstream consumers can query ML-BOMs through the API to validate imported models at deployment time.   |   2   |  V   |
