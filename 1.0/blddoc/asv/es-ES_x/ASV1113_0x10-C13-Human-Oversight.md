...
|   #    | Descripción                                                                                                                                                                                                                                     | Nivel | Rol |
| :----: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---: | :-: |
| 13.5.1 | Verifique que las fichas del modelo documenten los casos de uso previstos, las limitaciones y los modos de fallo conocidos.                                                                                                                     |   1   |  D  |
| 13.5.2 | Verifique que se divulguen las métricas de rendimiento en los diferentes casos de uso aplicables.                                                                                                                                               |   1   | D/V |
| 13.5.3 | Verifique que las consideraciones éticas, evaluaciones de sesgos, evaluaciones de equidad, características de los datos de entrenamiento y limitaciones conocidas de los datos de entrenamiento estén documentadas y actualizadas regularmente. |   2   |  D  |
| 13.5.4 | Verifique que las tarjetas de modelo estén controladas por versiones y se mantengan durante todo el ciclo de vida del modelo con seguimiento de cambios.                                                                                        |   2   | D/V |
...
| 13.6.4 | Verifique que la propagación de la incertidumbre se mantenga a lo largo de los flujos de trabajo de IA de múltiples pasos. |   3   | D/V |
...
|   #    | Descripción                                                                                                                                                  | Nivel | Rol |
| :----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---: | :-: |
| 13.7.1 | Verifique que las políticas de uso de datos y las prácticas de gestión del consentimiento del usuario estén claramente comunicadas a las partes interesadas. |   1   | D/V |
